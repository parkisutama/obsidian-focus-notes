import type { MoodEntry, QuadrantMeta } from "./MoodTypes.ts";

// Russell circumplex mood entries. Order and serialized keys are part of the persisted UI contract.
...
// Display metadata for the four circumplex quadrants.
