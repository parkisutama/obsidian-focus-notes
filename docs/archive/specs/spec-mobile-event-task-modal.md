...
- Populated note name, note search, folder, destination file, and heading inputs retain permanent semantic icons so their purpose does not depend on placeholder text.
