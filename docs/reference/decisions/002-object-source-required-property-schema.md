...
[the spec](../../archive/specs/spec-object-source-required-properties.md) and
[implementation plan](../../archive/tasks/object-source-required-properties-plan.md) for traceability.
